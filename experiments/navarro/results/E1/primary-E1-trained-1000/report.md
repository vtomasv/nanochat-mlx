...
Brazo: `trained_activation_profile`. Estado: `measured`. SHA: `b54b9fc139f455a9a5e60dc9a688ca9dbdb22944`. Hardware: Apple M3 Max; FP32; perfil primary; semilla 17; modalidad replay.
...
| Pico MLX (bytes) | null | null | 5883747160 |
| RSS máximo (bytes) | null | null | 2436562944 |
...
- Detailed trained-state profile; not a principal timing process.
