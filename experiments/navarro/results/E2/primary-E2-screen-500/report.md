...
Brazo: `compression_screen`. Estado: `measured`. SHA: `b54b9fc139f455a9a5e60dc9a688ca9dbdb22944`. Hardware: Apple M3 Max; FP32; perfil primary; semilla 17; modalidad replay.
...
| Pico MLX (bytes) | null | null | 905969664 |
| RSS máximo (bytes) | null | null | 1347256320 |
...
- Representation screening only; complete-model pilot required for a negative verdict.
- Independent compiled frequency-scan RePair, not author linear-time compressor.
